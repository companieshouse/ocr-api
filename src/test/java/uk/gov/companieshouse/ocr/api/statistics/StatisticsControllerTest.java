...
class StatisticsControllerTest {
    ...
    private final static int TEST_QUEUE_SIZE = 11;
    private final static int TEST_POOL_SIZE = 13;
    private final static int TEST_ACTIVE_POOL_SIZE = 12;
    private final static int TEST_LARGEST_POOL_SIZE = 14;
    ...
    void shouldGetStatistics() throws Exception {
        ...
        testStatistics.setPoolSize(TEST_POOL_SIZE);
        testStatistics.setActivePoolSize(TEST_ACTIVE_POOL_SIZE);
        testStatistics.setLargestPoolSize(TEST_LARGEST_POOL_SIZE);
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(apiEndpoint + StatisticsController.STATS_PARTIAL_URL))
                ...
                .andExpect(jsonPath("$.pool_size", is(TEST_POOL_SIZE)))
                .andExpect(jsonPath("$.active_pool_size", is(TEST_ACTIVE_POOL_SIZE)))
                .andExpect(jsonPath("$.largest_pool_size", is(TEST_LARGEST_POOL_SIZE)));
